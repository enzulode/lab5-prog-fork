...
import com.megateam.lab.common.command.impl.AddCommand;
...
public interface Resolver
{
	...
	{
		throw new DefaultResolverUsedException("Trying to invoke default resolve method. This is not possible.");
	}
