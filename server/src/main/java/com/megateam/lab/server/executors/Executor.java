...
public interface Executor
{
	...
	default boolean execute(Exchange exchange) throws ExecutionException, EnvException, DatabaseException
	{
		throw new DefaultExecutorUsedException("Default execute method had been invoked. It is not possible.");
	}
